<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label-width="100px" label="出库时间">
        <el-date-picker
          v-model="dateRange"
          size="small"
          style="width: 240px"
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出库编号" align="center" prop="stockId" v-if="columns[0].visible"/>
      ...
      <el-table-column label="经销商" align="center" prop="goods_username" v-if="columns[4].visible"/>
      <el-table-column label="出库类型" align="center" prop="stockType" v-if="columns[5].visible">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label-width="100px"label="出库编号" prop="stockId">
          <el-select v-model="form.stockId" placeholder="请选择出库编号" ref="stockSelection" :prop="form.stockId ? 'stockId' : ''" :disabled="!!form.stockId">
            <el-option
              v-for="item in stockList"
              v-if="item.stockStatus == '待审核' && item.stockType == '出库'"
              :key="item.stockName"
        ...
        <el-form-item label-width="100px" label="出库数量" prop="goodsNum" >
        ...
        <!--<el-form-item label-width="100px" label="出库状态" prop="goods_status">-->
        <!--<el-select v-model="form.goods_status" placeholder="出库状态">-->
        <!--<el-option label="待审核" value="待审核"></el-option>-->
        <!--<el-option label="审核通过" value="审核通过"></el-option>-->
        <!--<el-option label="审核未通过" value="审核未通过"></el-option>-->
        <!--</el-select>-->
        ...
        <el-form-item label-width="100px" label="经销商" prop="goods_userid" v-if="roles[0] != 'jingxiaoshang' && form.goods_stocktype == '出库'" >
        <el-select v-model="form.goods_userid" placeholder="请选择经销商" ref="userSelection"  >
        <el-option
        ...
        <!--<el-form-item label-width="100px" label="所属供货商" prop="goods_userid" v-if="form.goods_stocktype == '出库'">-->
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$modal.confirm('是否确认删除出库明细编号为"' + detailIds + '"的数据项？').then(function() {
